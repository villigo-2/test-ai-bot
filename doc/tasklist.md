...
- Выполнено: 0/10 → 1/10 → 2/10 → 3/10 → 4/10
- Журнал: Итерация 1 — согласован скелет бота (ENV, /start, /help, long polling); Итерация 2 — разбор ввода и маппинг стран; Итерация 3 — подключение Google Trends и вывод количества точек/диапазона; Итерация 4 — базовые метрики
